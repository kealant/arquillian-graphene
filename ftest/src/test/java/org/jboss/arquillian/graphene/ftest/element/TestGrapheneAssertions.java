...
public class TestGrapheneAssertions {
    ...
    @Test
    public void should_confirm_element_has_parent_web_element(){assertThat(div).hasParent();}

    @Test
    public void should_confirm_that_web_element_is_displayed_on_page(){assertThat(div).isVisible();}
    ...
    public void combining_assertions(){
        assertThat(div).hasText("pseudo root").hasParent().isVisible();
    }
